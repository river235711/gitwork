document.addEventListener("DOMContentLoaded", () => {
  ...
  const i18n = {
    zh: {
      ...
      "services.credit": "由曾任职 TSMC、MediaTek、Cadence、Qualcomm 与 Phison 的资深 CAD/PDK 工程师提供服务，15+ 年一线大厂实战经验。",
      "pdk.title": "PDK 开发与移植",
    ...
    en: {
      ...
      "services.credit": "Delivered by a senior CAD/PDK engineer with 15+ years at TSMC, MediaTek, Cadence, Qualcomm, and Phison.",
